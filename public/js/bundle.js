...
exports.showAlertAdmin = exports.showAlert = exports.hideAlert = void 0;
...
var showAlertAdmin = function showAlertAdmin(type, msg) {
  hideAlert();
  var markup = "<div class =\"alert alert--".concat(type, " fixed-top\">").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 3000);
};

exports.showAlertAdmin = showAlertAdmin;
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"signup.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Thanks For Signing Up');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"resetPassword.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Check Your Email for Reset Password');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your Password Successfully Updated');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
var stripe = Stripe('pk_test_51HZnyzAPu1NQnXrM53nTSQ05eVkOLEhGDlYfVsaL359XhcH61GpD2SxOeRAqYjkWmYXOlvbF55d1Ur3BEcBE9rqQ00ZxnjsAHs');
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"CRUD.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteDB = exports.editDB = exports.addDB = void 0;
...
var addDB = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, DB) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlertAdmin)('success', "Successfully");
            }
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlertAdmin)('error', _context.t0.response.data.message);
...
var editDB = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, DB, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/".concat(DB, "/").concat(id),
              data: data
            });
          ...
          case 3:
            ...
            window.setTimeout(function () {
              location.assign("/admin/".concat(DB, "/"));
            }, 1000);
            _context2.next = 11;
            break;
          ...
          case 8:
            _context2.prev = 8;
            _context2.t0 = _context2["catch"](0);
            (0, _alert.showAlertAdmin)('error', _context2.t0.response.data.message);
  ...
  return function editDB(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteDB = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(ID, DB) {
    var res;
  ...
  return function deleteDB(_x6, _x7) {
...
var bookBtn = document.getElementById('book-tour'); // ADMIN
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return (0, _resetPassword.forgotPassword)(email.value);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              token = document.getElementById('resetPassword').dataset.token;
              _context2.next = 7;
...
if (userForm) {
  userForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var userId, name, email, password, passwordConfirm, role;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              userId = document.querySelector('.userEdit');
              ...
              email = email.value;
              role = role.value;
              return _context4.abrupt("return", (0, _CRUD.editDB)({
                name: name,
                email: email,
                role: role
              }, 'users', userId));
...
if (tourForm) {
  tourForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
      var tourId, images, imageCover, form;
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault();
              tourId = document.querySelector('.tourEdit'); // const imageArray = [...document.querySelectorAll('#image')];
              // const images = imageArray.map(i => i.files[0]);

              images = document.querySelector('#images').files;
              imageCover = document.querySelector('#imageCover').files[0];
              form = new FormData();
              ...
              tourId = tourId.value;
              return _context5.abrupt("return", (0, _CRUD.editDB)(form, 'tours', tourId));

            case 20:
              (0, _CRUD.addDB)(form, 'tours');
...
if (bookingForm) {
  bookingForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(e) {
      var tourElement, user, tour, price;
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              e.preventDefault();
              tourElement = document.getElementById('tour');
              user = document.getElementById('user').value;
              tour = tourElement.value;
              price = tourElement.options[tourElement.selectedIndex].dataset.price;
              (0, _CRUD.addDB)({
                user: user,
                price: price,
                tour: tour
  ...
  deleteBtn.forEach(function (el) {
    el.addEventListener('click', /*#__PURE__*/function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(e) {
        var element, parentElement, data, ID, DB, deleteResult;
